...
**MP 20, ECE Department, Indian Institute of Science, Bengaluru**<br>
([📌 Map location](https://maps.app.goo.gl/pmMerf5hZDTgRtNt5))


#### Registration

<button><a href="https://forms.gle/wenEABHXDJbp2Kbv7" target="_blank">Registration Link</a></button>
...
<div class="tab-content">
  ...
  <div class="schedule-item"
       ...
       data-talktitle="Mixed-Mode Discrete-Continuous Diffusion for Molecule and Layout generation"
       data-abstract="In many applications, especially in science, we want generative models that simultaneously generate tightly coupled discrete and continuous tokens. This is a common feature in protein/molecule generation where a molecule consists of atoms and bonds that form a discrete vocabulary, along with the continuous 3D positions of these atoms. We propose a natural interleaving method between discrete and continuous denoising that can achieve this joint objective based on a time dependent variant of Gibbs sampling. We show results on molecule generation, layout generation and SAT solving.This is based on joint work with Sachin Yadav, Gautham Govind Anil, Dheeraj Nagaraj."
  ...
  <div class="schedule-item"
       ...
       data-title="Prof. Nikhil Karamchandani (IIT Bombay)"
...
<div class="container-fluid" align="center">
      <img src="/assets/img/Logos/1280px-Ministry_of_Education_India.svg.png" alt="MOE logo" class="img-fluid" style="height: 100px; width: auto; object-fit: contain;"/> 
      <img src="/assets/img/Logos/SPARCLogo.png" alt="SPARC logo" class="img-fluid" style="height: 100px; width: auto; object-fit: contain;"/>
